def highway_directions(highway_num):
	if 1 <= highway_num <= 99:
		...
		if 1 <= service_highway <= 99:
			...
			elif service_highway % 2 == 1: # change result value to == 1 b/c originally it was service_highway % 2 == 0, so test for even/odd same time but service highway is < 1 anyway. this jmps to ELSE
